...
cd /home/box/
#git clone git@github.com:moevm/mse_nosql_tasks_course_solutions.git solution
#cd ./solution
#git checkout geowithin-task1
#cd ..
git clone git@github.com:moevm/mse_nosql_tasks_course.git repo
cd ./repo
git checkout geowithin-task3
# /Machine setting up
...
# Here will be task initialization
 ...
 ./scripts/init_task.sh "mongodb_geowithin-task3" "esawwr3Xv41aSZCcVgz5AxcsBBBvtREssZEbFfbz3SCqzXBDSg"
# /Insert your task setup here
